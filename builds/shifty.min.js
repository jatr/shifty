...
(function(c){function a(a){var i;i=c.Tweenable.util.weakCopy(this._tweenParams.data.clamps||{},b.clamps);c.Tweenable.util.each(i,function(b,c){a.hasOwnProperty(c)&&(a[c]=Math.max(a[c],i[c].bottom),a[c]=Math.min(a[c],i[c].top))})}var b;if(c.Tweenable)b=c.Tweenable.util.setClamp=function(a,c,h){b.clamps[a]={bottom:c,top:h}},c.Tweenable.util.removeClamp=function(a){return delete b.clamps[a]},c.Tweenable.prototype.setClamp=function(a,b,c){if(!this._tweenParams.data.clamps)this._tweenParams.data.clamps=
